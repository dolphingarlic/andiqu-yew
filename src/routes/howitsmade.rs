            ...
            <section id="how-its-made">
                <div class="jumbotron">
                    <div class="container">
                        ...
                        <p>
                            {"I first heard about Yew after someone pointed
                            out that although the original "}
                            <strong>{"Andi Qu - The Website"}</strong>
                            {" didn't involve my writing any JS, it still
                            compiled to JS and was thus not truly JS-free."}
                        </p>
                        <p>
                            {"All interactive elements on this website (e.g.
                        ...
                        <p>
                            ...
                            my code to figure out how it works.)"}
                        </p>
                        <p>
